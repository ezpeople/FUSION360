...
{
    POST_VERSION                       = "v20230108.1.20250526"; // CORRECTION EZ 20250526 MAX_SPINDLE_SPEED=18000 + MIN_SPINDLE_SPEED=100 + TYPOS
    AUTHOR_NAME                        = "Nuno Vaz Oliveira";
}

// User configuration. Please change only these values on this file
{
    MIN_SPINDLE_SPEED                  = "100";                // Minimum spindle speed. The lower it gets the less torque. 600 is possible but useless...
    MAX_SPINDLE_SPEED                  = "18000";              // Maximum spindle speed. On Snapmaker 2.0 this is 12000rpm
